...
const contextMap = new WeakMap<HTMLDivElement, ScannerContext>();
...
export default function Scanner({
  ...
  useEffect(() => {
    ...
    (uniforms.uColor1.value as Float32Array).set(colorOne);
    (uniforms.uColor2.value as Float32Array).set(colorTwo);
    (uniforms.uColor3.value as Float32Array).set(colorThree);
